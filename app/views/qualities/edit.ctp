<?php $this->pageTitle = "Actualizando Evaluación de Calidad del Silo 100 - AdaptiveRTC"; ?>
...
<!--FORM ELEMENTS EXAMPLE-->            
	 <?php echo $form->create('Quality', array("class" => "nice", "action" => "edit")); ?>
        ...
        <p class="right">
			...
			<br clear="all" />
			<button class="green" type="submit">Actualizar Evaluación</button>
        </p>
        <div class="clear"></div>
      </form>
    </div>
...
<!-- START RIGHT CONTENT - Widget menu -->    
  <div class="grid_3">
    <!-- TODO WIDGET -->
	<?php echo $this->element("todos", array("section" => "qualities/edit", "silo_id" => $this->data["Quality"]["silo_id"])); ?>
    <br />
    <!-- ACTIVITY WIDGET -->
    <br />
  </div>
