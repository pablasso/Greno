<?php $this->pageTitle = "Actualizando Evaluación de Plaga al Silo 100 - AdaptiveRTC"; ?>
...
<!--FORM ELEMENTS EXAMPLE-->
	 <?php echo $form->create('Plague', array("class" => "nice", "action" => "edit")); ?>
...
<!-- START RIGHT CONTENT - Widget menu -->    
  <div class="grid_3">
    <!-- TODO WIDGET -->
	<?php echo $this->element("todos", array("section" => "plagues/edit", "silo_id" => $this->data["Plague"]["silo_id"])); ?>
    <br />
    <!-- ACTIVITY WIDGET -->
    <br />
  </div>
